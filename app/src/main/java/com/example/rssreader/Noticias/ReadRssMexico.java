...
/**
 * Created by web on 17/05/2016.
 */
public class ReadRssMexico extends AsyncTask<Void, Void, Void> {

    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/seccion/el-pais/mexico/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRssMexico(Context context,RecyclerView recyclerView) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MyAdapterMexico adapter=new MyAdapterMexico(context,feedItems);
