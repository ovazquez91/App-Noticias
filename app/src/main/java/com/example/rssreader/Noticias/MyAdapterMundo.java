 ...
 */
public class MyAdapterMundo extends RecyclerView.Adapter<MyAdapterMundo.MyViewHolder> {

    ArrayList<FeedItem> feedItems;
    Context context;
    public MyAdapterMundo(Context context,ArrayList<FeedItem>feedItems){
