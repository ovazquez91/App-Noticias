 ...
 */
public class MyAdapterMexico extends RecyclerView.Adapter<MyAdapterMexico.MyViewHolder> {

    ArrayList<FeedItem> feedItems;
    Context context;
    public MyAdapterMexico(Context context,ArrayList<FeedItem>feedItems){
