 ...
 */
public class ReadRssMundo extends AsyncTask<Void, Void, Void> {

    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/seccion/el-pais/mundo/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRssMundo(Context context,RecyclerView recyclerView) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MyAdapterMundo adapter=new MyAdapterMundo(context,feedItems);
