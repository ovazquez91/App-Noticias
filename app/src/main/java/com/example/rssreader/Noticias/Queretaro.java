...
public class Queretaro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Querétaro");
        ...
        ReadRssQro readRssqro=new ReadRssQro(this,recyclerView);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_queretaro, menu);
        return true;
    }
