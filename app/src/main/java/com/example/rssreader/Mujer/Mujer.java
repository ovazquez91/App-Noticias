...
import com.example.rssreader.Deportes.ReadRssDep;
...
public class Mujer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Mujer AM");
        ...
        ReadRssMujer readRssMujer =new ReadRssMujer(this,recyclerView);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_mujer, menu);
        return true;
    }
