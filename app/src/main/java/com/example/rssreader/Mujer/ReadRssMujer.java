...
import com.example.rssreader.Deportes.MyAdapterDep;
 ...
 */
public class ReadRssMujer extends AsyncTask<Void,Void,Void> {
    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/seccion/mujer-am/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRssMujer(Context context,RecyclerView recyclerView) {
