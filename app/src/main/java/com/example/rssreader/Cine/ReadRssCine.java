 ...
 */
public class ReadRssCine extends AsyncTask<Void, Void, Void>{
    ...
    URL url;
    public ReadRssCine(Context context,RecyclerView recyclerView) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MyAdapterCine adapter=new MyAdapterCine(context,feedItems);
