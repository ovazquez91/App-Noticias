...
/**
 * Created by web on 20/06/2016.
 */
public class ReadEspeciales  extends AsyncTask<Void, Void, Void> {
    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/queretaro/reportajes-especiales/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadEspeciales(Context context,RecyclerView recyclerView) {
