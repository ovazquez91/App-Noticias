...
import com.example.rssreader.Opinion.MyAdapterOpinion;
...
/**
 * Created by web on 16/05/2016.
 */
public class ReadRssVida extends AsyncTask<Void, Void, Void> {
    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/seccion/vivir-mas/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRssVida(Context context,RecyclerView recyclerView) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MyAdapterVida adapter=new MyAdapterVida(context,feedItems);
