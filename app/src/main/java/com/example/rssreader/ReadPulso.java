 ...
 */
public class ReadPulso extends AsyncTask<Void, Void, Void> {
    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/pulso-am/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;

    public ReadPulso(Context context,RecyclerView recyclerView) {
