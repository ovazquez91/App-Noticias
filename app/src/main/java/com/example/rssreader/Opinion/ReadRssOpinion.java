package com.example.rssreader.Opinion;
...
import com.example.rssreader.Noticias.MyAdapterQro;
...
/**
 * Created by web on 12/05/2016.
 */
public class ReadRssOpinion extends AsyncTask<Void, Void, Void> {
    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/seccion/opinion/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRssOpinion(Context context,RecyclerView recyclerView) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MyAdapterOpinion adapter=new MyAdapterOpinion(context,feedItems);
