package com.example.rssreader.Deportes;
...
import com.example.rssreader.Economia.MyAdapterEco;
 ...
 */
public class ReadRssDep extends AsyncTask<Void,Void,Void>{
    Context context;//http://www.sciencemag.org/rss/news_current.xml
    String address = "http://amqueretaro.com/seccion/deportes/feed";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRssDep(Context context,RecyclerView recyclerView) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MyAdapterDep adapter=new MyAdapterDep(context,feedItems);
